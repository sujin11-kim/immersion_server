...
let UserImplement = class UserImplement {
    constructor(userRepository, userEntityRepository) {
    ...
    async createUser(userInfo) {
        ...
        try {
            ...
            const newUser = await this.userRepository.saveUser(Object.assign(Object.assign({}, userInfo), { password: hashedPassword }));
...
exports.UserImplement = UserImplement;
