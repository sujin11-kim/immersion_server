...
], ReviewImage.prototype, "imageIdx", void 0);
__decorate([
    (0, typeorm_1.Column)("int", { name: "reviewIdx" }),
    __metadata("design:type", Number)
], ReviewImage.prototype, "reviewIdx", void 0);
__decorate([
    (0, typeorm_1.Column)("varchar", { name: "imagePath", length: 1000 }),
    __metadata("design:type", String)
], ReviewImage.prototype, "imagePath", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Review_1.Review, (review) => review.reviewIdx, {
        onDelete: "NO ACTION",
        onUpdate: "NO ACTION",
    }),
    (0, typeorm_1.JoinColumn)([{ name: "reviewIdx", referencedColumnName: "reviewIdx" }]),
    __metadata("design:type", Review_1.Review)
], ReviewImage.prototype, "reviewIdx2", void 0);
ReviewImage = __decorate([
    (0, typeorm_1.Entity)("ReviewImage", { schema: "immersion_DB" })
], ReviewImage);
